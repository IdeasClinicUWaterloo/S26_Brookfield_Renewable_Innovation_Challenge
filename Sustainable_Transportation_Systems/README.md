...
Before preparing your presentation, **review** the **Judging Rubric** and **Presentation Instructions** to ensure all requirements are met.
## Potential Solutions
...
|:---------|:------------|:----------|
| **Carpooling platform** | Develop a system that matches students and staff with similar commuting routes and schedules (e.g., daily commuting or weekend trips home). | <ul></li><li>Route optimization libraries (OSRM, NetworkX)</li><li>Google Maps API Documentation</li><li>Integration with campus authentication</li></ul> |
...
- [Aggregated Breakdown of the fleet vehicles in UW](https://uofwaterloo-my.sharepoint.com/:x:/g/personal/a33zahid_uwaterloo_ca/IQCj5yKPyornQoAuvH_d_3UBAf2Vj8W53vGxdsvx1zFtktU?e=TbR4Kb)
